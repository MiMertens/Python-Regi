...
class Registratie(tkinter.Tk):
    ...
    def OnDoubleClick(self, event):
        ...
        self.Entry_Locatie.insert(0, self.tree.item(item)['values'][1][0])
        self.Entry_Opslag.insert(0, self.tree.item(item)['values'][2][0]) 
        self.Entry_Medewerker.insert(0, self.tree.item(item)['values'][4][0]) 
        self.Entry_Apparaat.insert(0, self.tree.item(item)['values'][5][0]) 
    ...
    def Getentry(self):
        ...
        self.opslag = self.Entry_Opslag.get()
        self.medewerker = self.Entry_Medewerker.get()
        self.recycle = self.Entry_Apparaat.get()
        self.aantal = self.Entry_Aantal.get() 
